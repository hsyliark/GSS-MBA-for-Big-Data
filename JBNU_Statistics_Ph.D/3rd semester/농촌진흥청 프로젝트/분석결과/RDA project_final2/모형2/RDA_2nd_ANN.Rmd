...
- RMSE=0.863062, SSE/SST=0.02882439
...
- RMSE=1.001796, SSE/SST=0.03883605
- 적합결과 test RMSE 값이 다중회귀모형(0.1330)과 비교했을 때 더 작은 값이므로 이 ANN 모형이 다중회귀모형보다 예측력이 좋다고 해석할 수 있다.
...
- RMSE=1.17249, SSE/SST=0.04073942
...
- RMSE=1.282065, SSE/SST=0.04870989
