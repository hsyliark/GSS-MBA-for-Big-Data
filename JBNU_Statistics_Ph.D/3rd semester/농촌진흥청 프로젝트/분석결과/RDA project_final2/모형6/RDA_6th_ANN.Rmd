...
- RMSE=11.69821, SSE/SST=0.05798381
...
- RMSE=11.71952, SSE/SST=0.0581953
- 적합결과 test RMSE 값이 다중회귀모형(23.3802)과 비교했을 때 더 작은 값이므로 이 ANN 모형이 다중회귀모형보다 예측력이 좋다고 해석할 수 있다.
...
- RMSE=4.140058, SSE/SST=0.08823129
...
- RMSE=4.434662, SSE/SST=0.101235
- 적합결과 test RMSE 값이 다중회귀모형(6.8861)과 비교했을 때 더 작은 값이므로 이 ANN 모형이 다중회귀모형보다 예측력이 좋다고 해석할 수 있다.
