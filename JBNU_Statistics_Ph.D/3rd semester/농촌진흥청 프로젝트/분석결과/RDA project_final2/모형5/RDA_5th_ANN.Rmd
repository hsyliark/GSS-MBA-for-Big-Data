...
- RMSE=1.113862, SSE/SST=0.09491423
...
- RMSE=1.011524, SSE/SST=0.07827474
- 적합결과 test RMSE 값이 다중회귀모형(1.6420)과 비교했을 때 더 작은 값이므로 이 ANN 모형이 다중회귀모형보다 예측력이 좋다고 해석할 수 있다.
...
- RMSE=2.414533, SSE/SST=0.1339245
...
- RMSE=2.509176, SSE/SST=0.1446292
- 적합결과 test RMSE 값이 다중회귀모형(2.5524)과 비교했을 때 비슷한 수준이다.
