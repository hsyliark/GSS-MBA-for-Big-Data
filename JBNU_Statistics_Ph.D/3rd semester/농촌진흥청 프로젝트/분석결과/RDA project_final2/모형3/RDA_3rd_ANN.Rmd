...
- RMSE=0.8414093, SSE/SST=0.04446235
...
- RMSE=0.7938016, SSE/SST=0.03957325
- 적합결과 test RMSE 값이 다중회귀모형(1.1354)과 비교했을 때 더 작은 값이므로 이 ANN 모형이 다중회귀모형보다 예측력이 좋다고 해석할 수 있다.
...
- RMSE=1.248356, SSE/SST=0.09855809
...
- RMSE=1.056562, SSE/SST=0.0706001
- 적합결과 test RMSE 값이 다중회귀모형(1.3087)과 비교했을 때 더 작은 값이므로 이 ANN 모형이 다중회귀모형보다 예측력이 좋다고 해석할 수 있다.
