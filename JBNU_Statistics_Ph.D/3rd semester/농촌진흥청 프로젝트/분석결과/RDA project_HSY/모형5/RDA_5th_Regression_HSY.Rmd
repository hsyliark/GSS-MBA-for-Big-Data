...
```{r}
summary(lm(내외부상대습도차~(외부기온+외부상대습도+외부풍속+외부일사량+환기창면적)^2,data=plantno))
```
...
```{r}
summary(lm(내외부상대습도차~(외부기온+외부상대습도+외부풍속+외부일사량+환기창면적)^2,data=plantyes))
```
...
```{r}
summary(lm(내외부상대습도차~외부기온+외부상대습도+외부풍속+외부일사량+환기창면적+작물유무+외부풍속*외부일사량+외부상대습도*외부일사량+작물유무*외부기온+작물유무*외부상대습도+작물유무*외부풍속+작물유무*환기창면적,data=plant))
```
...
- 결과적으로 4가지 모형들 중 최초로 고려한 모형이 가장 우수하였다. 하지만 test RMSE의 값은 4가지 모형 모두 거의 비슷하였다.

```{r}
summary(lm(내외부상대습도차~외부기온+외부상대습도+외부풍속+외부일사량+환기창면적+작물유무+외부풍속*외부일사량+외부상대습도*외부일사량+작물유무*외부기온+작물유무*외부상대습도+작물유무*외부풍속+작물유무*외부일사량+작물유무*환기창면적,data=plant))
```
