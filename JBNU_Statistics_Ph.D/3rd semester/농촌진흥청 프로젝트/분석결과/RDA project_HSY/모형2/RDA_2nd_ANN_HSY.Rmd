...
- 적합결과 test RMSE의 값이 약 0.8522로 산출되었다. 이는 다중회귀모형과 비교했을 때 더 작은 값이므로 이 ANN 모형이 다중회귀모형보다 예측력이 좋다고 해석할 수 있다.
...
- 적합결과 test RMSE의 값이 약 0.8552로 산출되었다. 첫번째 모형의 결과와 동일하게 이는 다중회귀모형과 비교했을 때 더 작은 값이므로 이 ANN 모형이 다중회귀모형보다 예측력이 좋다고 해석할 수 있다.
...
- 적합결과 test RMSE의 값이 약 0.9673으로 산출되었다. 이는 다중회귀모형과 비교했을 때 더 작은 값이므로 이 ANN 모형이 다중회귀모형보다 예측력이 좋다고 해석할 수 있다.
...
- 적합결과 test RMSE의 값이 약 0.9554로 산출되었다. 첫번째 모형의 결과와 동일하게 이는 다중회귀모형과 비교했을 때 더 작은 값이므로 이 ANN 모형이 다중회귀모형보다 예측력이 좋다고 해석할 수 있다.
