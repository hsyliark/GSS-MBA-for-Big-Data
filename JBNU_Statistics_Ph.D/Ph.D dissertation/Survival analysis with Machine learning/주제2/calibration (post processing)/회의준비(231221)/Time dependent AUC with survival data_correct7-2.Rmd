---
title: "Time dependent AUC with survival data _ correct7-2"
...
- model : $h(t|x)=h_{0}(t)exp[f(x)]$
- $f(x)=\beta x$
- $h_{0}(t)=\lambda$
- True coefficients : $\beta=3$
...
for (i in 1:1000) {
  ...
  Y[i] <- -(1/lambda1)*log(U1[i])*exp(-beta0*X[i])
  C[i] <- (lambda2)*(1-U2[i])
  t[i] <- min(Y[i],C[i])
...
```{r}
con.AUC <- matrix(nrow=length(seq(0,70,0.01)),ncol=100)
...
for (i in 1:100) {
  ...
  for (j in 1:200) {
    ...
    Y[j] <- -(1/lambda1)*log(U1[j])*exp(-beta0*X[j])
    C[j] <- (lambda2)*(1-U2[j])
    t[j] <- min(Y[j],C[j])
...
dat5 <- data.frame(time=seq(0,70,0.01), con.AUC=rowMeans(con.AUC, na.rm=TRUE))
plot(x=dat5$time, y=dat5$con.AUC, xlab="time", ylab="mean of AUC",
     main="Simulate 100 times [X ~ U(0,1)]", type="l", col="red", ylim=c(0.5,1))
```
...
dat5 <- data.frame(time=seq(0,70,0.01), con.AUC=rowMeans(con.AUC, na.rm=TRUE))
plot(x=dat5$time, y=dat5$con.AUC, xlab="time", ylab="mean of AUC",
     main="Simulate 100 times [X ~ N(0,1^2)]", type="l", col="red", ylim=c(0.94,1))
```
...
for (i in 1:1000) {
  U1[i] <- runif(1)
  U2[i] <- runif(1)
  X[i] <- rcauchy(1,location=0,scale=1)
  Y[i] <- -(1/lambda1)*log(U1[i])*exp(-beta0*X[i])
  C[i] <- (lambda2)*(1-U2[i])
  t[i] <- min(Y[i],C[i])
  censor[i] <- ifelse(Y[i]<=C[i],1,0)
...
for (i in 1:100) {
  ...
  for (j in 1:200) {
    U1[j] <- runif(1)
    U2[j] <- runif(1)
    X[j] <- rcauchy(1,location=0,scale=1)
    Y[j] <- -(1/lambda1)*log(U1[j])*exp(-beta0*X[j])
    C[j] <- (lambda2)*(1-U2[j])
    t[j] <- min(Y[j],C[j])
    censor[j] <- ifelse(Y[j]<=C[j],1,0)
...
dat5 <- data.frame(time=seq(0,70,0.01), con.AUC=rowMeans(con.AUC, na.rm=TRUE))
plot(x=dat5$time, y=dat5$con.AUC, xlab="time", ylab="mean of AUC",
     main="Simulate 100 times [X ~ Cauchy(0,1)]", type="l", col="red", ylim=c(0.96,1))
```


### Case 4) X ~ Exponential
...
dat5 <- data.frame(time=seq(0,70,0.01), con.AUC=rowMeans(con.AUC, na.rm=TRUE))
plot(x=dat5$time, y=dat5$con.AUC, xlab="time", ylab="mean of AUC",
     main="Simulate 100 times [X ~ Exp(1)]", type="l", col="red", ylim=c(0.85,1))
```
...
## Continuous time-varying covariate: exponential distribution of event times
...
```{r}
con.AUC <- matrix(nrow=length(seq(0,20,0.01)),ncol=100)
...
dat5 <- data.frame(time=seq(0,20,0.01), con.AUC=rowMeans(con.AUC, na.rm=TRUE))
plot(x=dat5$time, y=dat5$con.AUC, xlab="time", ylab="mean of AUC",
     main="Continuous time-varying covariate \n (Exponential distribution of event times), X ~ U(0,1)", type="l", col="blue", ylim=c(0.2,1))
```
...
```{r}
con.AUC <- matrix(nrow=length(seq(0,40,0.01)),ncol=100)
...
dat5 <- data.frame(time=seq(0,40,0.01), con.AUC=rowMeans(con.AUC, na.rm=TRUE))
plot(x=dat5$time, y=dat5$con.AUC, xlab="time", ylab="mean of AUC",
     main="Continuous time-varying covariate \n (Exponential distribution of event times), X ~ N(0,1^2)", type="l", col="blue", ylim=c(0.94,1))
```
...
```{r}
con.AUC <- matrix(nrow=length(seq(0,65,0.01)),ncol=100)
...
dat5 <- data.frame(time=seq(0,65,0.01), con.AUC=rowMeans(con.AUC, na.rm=TRUE))
plot(x=dat5$time, y=dat5$con.AUC, xlab="time", ylab="mean of AUC",
     main="Continuous time-varying covariate \n (Exponential distribution of event times), X ~ Cauchy(0,1)", type="l", col="blue", ylim=c(0.97,1))
```
...
dat5 <- data.frame(time=seq(0,20,0.01), con.AUC=rowMeans(con.AUC, na.rm=TRUE))
plot(x=dat5$time, y=dat5$con.AUC, xlab="time", ylab="mean of AUC",
     main="Continuous time-varying covariate \n (Exponential distribution of event times), X ~ Exp(1)", type="l", col="blue", ylim=c(0.85,1))
```
...
```{r}
con.AUC <- matrix(nrow=length(seq(0,300,0.1)),ncol=100)
...
dat5 <- data.frame(time=seq(0,300,0.1), con.AUC=rowMeans(con.AUC, na.rm=TRUE))
plot(x=dat5$time, y=dat5$con.AUC, xlab="time", ylab="mean of AUC",
     main="Dichotomous time-varying covariate \n (Exponential distribution of event times), X ~ U(0,1)", type="l", col="green", ylim=c(0.5,1))
```
...
```{r}
con.AUC <- matrix(nrow=length(seq(0,900,0.1)),ncol=100)
...
dat5 <- data.frame(time=seq(0,900,0.1), con.AUC=rowMeans(con.AUC, na.rm=TRUE))
plot(x=dat5$time, y=dat5$con.AUC, xlab="time", ylab="mean of AUC",
     main="Dichotomous time-varying covariate \n (Exponential distribution of event times), X ~ N(0,1^2)", type="l", col="green", ylim=c(0.94,1))
```
...
dat5 <- data.frame(time=seq(0,900,0.1), con.AUC=rowMeans(con.AUC, na.rm=TRUE))
plot(x=dat5$time, y=dat5$con.AUC, xlab="time", ylab="mean of AUC",
     main="Dichotomous time-varying covariate \n (Exponential distribution of event times), X ~ Cauchy(0,1)", type="l", col="green", ylim=c(0.95,1))
```
...
```{r}
con.AUC <- matrix(nrow=length(seq(0,400,0.1)),ncol=100)
...
dat5 <- data.frame(time=seq(0,400,0.1), con.AUC=rowMeans(con.AUC, na.rm=TRUE))
plot(x=dat5$time, y=dat5$con.AUC, xlab="time", ylab="mean of AUC",
     main="Dichotomous time-varying covariate \n (Exponential distribution of event times), X ~ Exp(1)", type="l", col="green", ylim=c(0.85,1))
```