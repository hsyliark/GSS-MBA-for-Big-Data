---
title: "Time dependent AUC with survival data _ correct2"
...
- When parametric basis distribution of real survival time $Y$ is Exponential distribution and censoring time $C$ is Uniform distribution ($Y$ and $C$ are independent each other), then ~
...
lambda2 <- 2/lambda1 # parameter for generate C 
beta1 <- 3 # true coefficients
Y <- c() # real survival time
C <- c() # censoring time
t <- c() # observed survival time
