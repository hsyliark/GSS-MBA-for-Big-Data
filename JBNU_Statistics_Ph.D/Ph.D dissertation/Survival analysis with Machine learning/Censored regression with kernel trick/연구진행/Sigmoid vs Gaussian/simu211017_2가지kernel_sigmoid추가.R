...
my.kernel.matrix1 <- function(dat.train, dat.test) {
  ...
  K <- tanh(gamma*D + 1) # sigmoid kernel
  K.train <- K[1:n,1:n]
  K.test <- K[1:n,(n+1):n1]
...
fit.ftn1 <- function(number1, number2, a) {
  ...
  boxplot(SKR1)
  boxplot(SKR2)
  dat1_1 <- data.frame(RMSE=SKR1, method=rep("a.SKR1",100), number=as.character(rep(n.train,100)))
  dat1_2 <- data.frame(RMSE=SKR2, method=rep("i.SKR2",100), number=as.character(rep(n.train,100)))
  ...
  boxplot(SKRS1)
  boxplot(SKRS2)
  dat3_1 <- data.frame(RMSE=SKRS1, method=rep("b.SKRS1",100), number=as.character(rep(n.train,100)))
  dat3_2 <- data.frame(RMSE=SKRS2, method=rep("j.SKRS2",100), number=as.character(rep(n.train,100)))
  ...
  for (s in 1:100) {
    ...
    SKRB1[s] <- sqrt(sum((y.test.s - y.hat1.bag)^2)/length(y.test.s))
    SKRB2[s] <- sqrt(sum((y.test - y.hat2.bag)^2)/length(y.test))
  ...
  boxplot(SKRB1)
  boxplot(SKRB2)
  dat5_1 <- data.frame(RMSE=SKRB1, method=rep("c.SKRB1",100), number=as.character(rep(n.train,100)))
  dat5_2 <- data.frame(RMSE=SKRB2, method=rep("k.SKRB2",100), number=as.character(rep(n.train,100)))
  ...
  for (s in 1:100) {
    ...
    SKRR1[s] <- sqrt(sum((test.sim.y.s - y.hat1.rf)^2)/length(test.sim.y.s))
    SKRR2[s] <- sqrt(sum((test.sim.y - y.hat2.rf)^2)/length(test.sim.y))
  ...
  boxplot(SKRR1)
  boxplot(SKRR2)
  dat7_1 <- data.frame(RMSE=SKRR1, method=rep("d.SKRR1",100), number=as.character(rep(n.train,100)))
  dat7_2 <- data.frame(RMSE=SKRR2, method=rep("l.SKRR2",100), number=as.character(rep(n.train,100)))
...
write.csv(dat.res1, "C:/Users/Administrator/Desktop/Sigmoid vs Gaussian/p3cen0.csv")


# Print result
mean(dat.res1_1$RMSE[dat.res1_1$method=="a.SKR1"])
sd(dat.res1_1$RMSE[dat.res1_1$method=="a.SKR1"])
mean(dat.res1_1$RMSE[dat.res1_1$method=="b.SKRS1"])
sd(dat.res1_1$RMSE[dat.res1_1$method=="b.SKRS1"])
mean(dat.res1_1$RMSE[dat.res1_1$method=="c.SKRB1"])
sd(dat.res1_1$RMSE[dat.res1_1$method=="c.SKRB1"])
mean(dat.res1_1$RMSE[dat.res1_1$method=="d.SKRR1"])
sd(dat.res1_1$RMSE[dat.res1_1$method=="d.SKRR1"])
...
mean(dat.res1_1$RMSE[dat.res1_1$method=="i.SKR2"])
sd(dat.res1_1$RMSE[dat.res1_1$method=="i.SKR2"])
mean(dat.res1_1$RMSE[dat.res1_1$method=="j.SKRS2"])
sd(dat.res1_1$RMSE[dat.res1_1$method=="j.SKRS2"])
mean(dat.res1_1$RMSE[dat.res1_1$method=="k.SKRB2"])
sd(dat.res1_1$RMSE[dat.res1_1$method=="k.SKRB2"])
mean(dat.res1_1$RMSE[dat.res1_1$method=="l.SKRR2"])
sd(dat.res1_1$RMSE[dat.res1_1$method=="l.SKRR2"])
...
mean(dat.res1_2$RMSE[dat.res1_2$method=="a.SKR1"])
sd(dat.res1_2$RMSE[dat.res1_2$method=="a.SKR1"])
mean(dat.res1_2$RMSE[dat.res1_2$method=="b.SKRS1"])
sd(dat.res1_2$RMSE[dat.res1_2$method=="b.SKRS1"])
mean(dat.res1_2$RMSE[dat.res1_2$method=="c.SKRB1"])
sd(dat.res1_2$RMSE[dat.res1_2$method=="c.SKRB1"])
mean(dat.res1_2$RMSE[dat.res1_2$method=="d.SKRR1"])
sd(dat.res1_2$RMSE[dat.res1_2$method=="d.SKRR1"])
...
mean(dat.res1_2$RMSE[dat.res1_2$method=="i.SKR2"])
sd(dat.res1_2$RMSE[dat.res1_2$method=="i.SKR2"])
mean(dat.res1_2$RMSE[dat.res1_2$method=="j.SKRS2"])
sd(dat.res1_2$RMSE[dat.res1_2$method=="j.SKRS2"])
mean(dat.res1_2$RMSE[dat.res1_2$method=="k.SKRB2"])
sd(dat.res1_2$RMSE[dat.res1_2$method=="k.SKRB2"])
mean(dat.res1_2$RMSE[dat.res1_2$method=="l.SKRR2"])
sd(dat.res1_2$RMSE[dat.res1_2$method=="l.SKRR2"])
...
mean(dat.res1_3$RMSE[dat.res1_3$method=="a.SKR1"])
sd(dat.res1_3$RMSE[dat.res1_3$method=="a.SKR1"])
mean(dat.res1_3$RMSE[dat.res1_3$method=="b.SKRS1"])
sd(dat.res1_3$RMSE[dat.res1_3$method=="b.SKRS1"])
mean(dat.res1_3$RMSE[dat.res1_3$method=="c.SKRB1"])
sd(dat.res1_3$RMSE[dat.res1_3$method=="c.SKRB1"])
mean(dat.res1_3$RMSE[dat.res1_3$method=="d.SKRR1"])
sd(dat.res1_3$RMSE[dat.res1_3$method=="d.SKRR1"])
...
mean(dat.res1_3$RMSE[dat.res1_3$method=="i.SKR2"])
sd(dat.res1_3$RMSE[dat.res1_3$method=="i.SKR2"])
mean(dat.res1_3$RMSE[dat.res1_3$method=="j.SKRS2"])
sd(dat.res1_3$RMSE[dat.res1_3$method=="j.SKRS2"])
mean(dat.res1_3$RMSE[dat.res1_3$method=="k.SKRB2"])
sd(dat.res1_3$RMSE[dat.res1_3$method=="k.SKRB2"])
mean(dat.res1_3$RMSE[dat.res1_3$method=="l.SKRR2"])
sd(dat.res1_3$RMSE[dat.res1_3$method=="l.SKRR2"])
