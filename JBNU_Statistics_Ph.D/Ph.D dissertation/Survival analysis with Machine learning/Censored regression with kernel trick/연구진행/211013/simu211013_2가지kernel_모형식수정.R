...
write.csv(dat.res1, "C:/Users/Administrator/Desktop/211013/p3cen0.csv")
...
mean(dat.res1_1$RMSE[dat.res1_1$method=="i.LKR2"])
sd(dat.res1_1$RMSE[dat.res1_1$method=="i.LKR2"])
mean(dat.res1_1$RMSE[dat.res1_1$method=="j.LKRS2"])
sd(dat.res1_1$RMSE[dat.res1_1$method=="j.LKRS2"])
mean(dat.res1_1$RMSE[dat.res1_1$method=="k.LKRB2"])
sd(dat.res1_1$RMSE[dat.res1_1$method=="k.LKRB2"])
mean(dat.res1_1$RMSE[dat.res1_1$method=="l.LKRR2"])
sd(dat.res1_1$RMSE[dat.res1_1$method=="l.LKRR2"])
...
mean(dat.res1_2$RMSE[dat.res1_2$method=="i.LKR2"])
sd(dat.res1_2$RMSE[dat.res1_2$method=="i.LKR2"])
mean(dat.res1_2$RMSE[dat.res1_2$method=="j.LKRS2"])
sd(dat.res1_2$RMSE[dat.res1_2$method=="j.LKRS2"])
mean(dat.res1_2$RMSE[dat.res1_2$method=="k.LKRB2"])
sd(dat.res1_2$RMSE[dat.res1_2$method=="k.LKRB2"])
mean(dat.res1_2$RMSE[dat.res1_2$method=="l.LKRR2"])
sd(dat.res1_2$RMSE[dat.res1_2$method=="l.LKRR2"])
...
mean(dat.res1_3$RMSE[dat.res1_3$method=="i.LKR2"])
sd(dat.res1_3$RMSE[dat.res1_3$method=="i.LKR2"])
mean(dat.res1_3$RMSE[dat.res1_3$method=="j.LKRS2"])
sd(dat.res1_3$RMSE[dat.res1_3$method=="j.LKRS2"])
mean(dat.res1_3$RMSE[dat.res1_3$method=="k.LKRB2"])
sd(dat.res1_3$RMSE[dat.res1_3$method=="k.LKRB2"])
mean(dat.res1_3$RMSE[dat.res1_3$method=="l.LKRR2"])
sd(dat.res1_3$RMSE[dat.res1_3$method=="l.LKRR2"])
