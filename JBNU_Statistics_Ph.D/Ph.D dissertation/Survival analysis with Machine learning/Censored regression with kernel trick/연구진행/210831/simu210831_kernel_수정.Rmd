---
title: "Simulation_kernel (210831)"
author: "Hwang Seong-Yun"
date: '2021 9 2 '
output: html_document
---

## Censored regression with kernel trick
- Censored regression with synthetic response(KSV)
- Kernel ridge regression with Gaussian(Radial Basis) kernel
- Sub-sampling (Huh.M, 2015)
- Bagging and Random Forest (Han.S, 2016 / Hwang.S, 2017) 
...
cen.10 <-rnorm(500, mean=sin(2*pi*x1.i*x2.i)+cos(2*pi*x3.i*x4.i*x5.i)+0.84^2, sd=1) # censoring values
...
fit.ftn1 <- function(dat.sim) {
  ...
  KR
  boxplot(KR)
  dat1 <- data.frame(RMSE=KR, method=rep("1.KR",1000), number=as.character(rep(n.train,1000)))
  ...
  KRS
  boxplot(KRS)
  dat2 <- data.frame(RMSE=KRS, method=rep("2.KRS",1000), number=as.character(rep(n.train,1000)))
  ...
  KRB
  boxplot(KRB)
  dat3 <- data.frame(RMSE=KRB, method=rep("3.KRB",1000), number=as.character(rep(n.train,1000)))
  ...
  KRR
  boxplot(KRR)
  dat4 <- data.frame(RMSE=KRR, method=rep("4.KRR",1000), number=as.character(rep(n.train,1000)))
