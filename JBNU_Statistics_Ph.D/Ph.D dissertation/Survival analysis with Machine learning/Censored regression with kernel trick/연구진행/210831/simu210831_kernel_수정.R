...
y.i <- sin(2*pi*x1.i*x2.i)+e.i
pred.value <-  sin(2*pi*seq(0,1,length.out=100)*seq(0,1,length.out=100))
cen.10 <-rnorm(100, mean=sin(2*pi*x1.i*x2.i)+0.84^2, sd=1) # censoring values
...
dat1 <- data.frame(y=y.i, ys=y.i.10, c=cen.10, d=delta.10, yp=pred.value, x1=x1.i, x2=x2.i)
dat.sim <- data.frame(ys=y.i.10, x1=x1.i, x2=x2.i, yp=pred.value)
