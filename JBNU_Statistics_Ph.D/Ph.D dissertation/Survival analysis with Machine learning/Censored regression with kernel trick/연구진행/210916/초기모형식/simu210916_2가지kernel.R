...
dat.gen <- function(n, a, seed=NULL){
  ...
  y.i.s <- ifelse(pre.T <= quantile(pre.T, probs=0.98), pre.T*delta/g, 0) # synthetic response
...
dat.res2 <- fit.ftn(100, 50, 10) # censoring 0%
dat.res2 <- fit.ftn(100, 50, 2.5) # censoring 10%
dat.res2 <- fit.ftn(100, 50, 1.5) # censoring 30%
dat.res2 <- fit.ftn(100, 50, 0.7) # censoring 50%
