...
dat.gen <- function(n, a, seed=NULL){
  ...
  y.i <- sin(2*pi*(x1.i*x2.i*x3.i*x4.i*x5.i))+cos(2*pi*(x6.i*x7.i*x8.i*x9.i*x10.i))+e.i
...
dat.res2 <- fit.ftn(50, 1000, 2.82) # censoring 10%
dat.res2 <- fit.ftn(50, 1000, 1.65) # censoring 30%
dat.res2 <- fit.ftn(50, 1000, 0.87) # censoring 50%
