...
fit.ftn1 <- function(number1, number2, a) {
  ...
  boxplot(KRS1)
  boxplot(KRS2)
  dat3_1 <- data.frame(RMSE=KRS1, method=rep("e.KRS1",100), number=as.character(rep(n.train,100)))
  dat3_2 <- data.frame(RMSE=KRS2, method=rep("f.KRS2",100), number=as.character(rep(n.train,100)))
  ...
  boxplot(KRS3)
  boxplot(KRS4)
  dat4_1 <- data.frame(RMSE=KRS3, method=rep("g.KRS3",100), number=as.character(rep(n.train,100)))
  dat4_2 <- data.frame(RMSE=KRS4, method=rep("h.KRS4",100), number=as.character(rep(n.train,100)))
  ...
  boxplot(KRB1)
  boxplot(KRB2)
  dat5_1 <- data.frame(RMSE=KRB1, method=rep("i.KRB1",100), number=as.character(rep(n.train,100)))
  dat5_2 <- data.frame(RMSE=KRB2, method=rep("j.KRB2",100), number=as.character(rep(n.train,100)))
  ...
  boxplot(KRB3)
  boxplot(KRB4)
  dat6_1 <- data.frame(RMSE=KRB3, method=rep("k.KRB3",100), number=as.character(rep(n.train,100)))
  dat6_2 <- data.frame(RMSE=KRB4, method=rep("l.KRB4",100), number=as.character(rep(n.train,100)))
  ...
  boxplot(KRR1)
  boxplot(KRR2)
  dat7_1 <- data.frame(RMSE=KRR1, method=rep("m.KRR1",100), number=as.character(rep(n.train,100)))
  dat7_2 <- data.frame(RMSE=KRR2, method=rep("n.KRR2",100), number=as.character(rep(n.train,100)))
  ...
  boxplot(KRR3)
  boxplot(KRR4)
  dat8_1 <- data.frame(RMSE=KRR3, method=rep("o.KRR3",100), number=as.character(rep(n.train,100)))
  dat8_2 <- data.frame(RMSE=KRR4, method=rep("p.KRR4",100), number=as.character(rep(n.train,100)))
...
ggplot(dat.res3_1, aes(x = method, y = RMSE, fill = method)) + geom_boxplot() 
ggplot(dat.res3_2, aes(x = method, y = RMSE, fill = method)) + geom_boxplot()
ggplot(dat.res3_3, aes(x = method, y = RMSE, fill = method)) + geom_boxplot()
# Boxplot for row binded dataset
dat.res3[dat.res3$number==50,]$number <- "1(50)"
dat.res3[dat.res3$number==100,]$number <- "2(100)"
dat.res3[dat.res3$number==200,]$number <- "3(200)"
ggplot(dat.res3, aes(x = number, y = RMSE, fill = number)) + geom_boxplot() +
  facet_wrap(~ method, ncol=16) + theme(axis.text.x=element_text(angle=45, hjust=1))


# Print result
mean(dat.res3_1$RMSE[dat.res3_1$method=="a.KR1"])
sd(dat.res3_1$RMSE[dat.res3_1$method=="a.KR1"])
mean(dat.res3_1$RMSE[dat.res3_1$method=="b.KR2"])
sd(dat.res3_1$RMSE[dat.res3_1$method=="b.KR2"])
mean(dat.res3_1$RMSE[dat.res3_1$method=="c.KR3"])
sd(dat.res3_1$RMSE[dat.res3_1$method=="c.KR3"])
mean(dat.res3_1$RMSE[dat.res3_1$method=="d.KR4"])
sd(dat.res3_1$RMSE[dat.res3_1$method=="d.KR4"])

mean(dat.res3_1$RMSE[dat.res3_1$method=="e.KRS1"])
sd(dat.res3_1$RMSE[dat.res3_1$method=="e.KRS1"])
mean(dat.res3_1$RMSE[dat.res3_1$method=="f.KRS2"])
sd(dat.res3_1$RMSE[dat.res3_1$method=="f.KRS2"])
mean(dat.res3_1$RMSE[dat.res3_1$method=="g.KRS3"])
sd(dat.res3_1$RMSE[dat.res3_1$method=="g.KRS3"])
mean(dat.res3_1$RMSE[dat.res3_1$method=="h.KRS4"])
sd(dat.res3_1$RMSE[dat.res3_1$method=="h.KRS4"])

mean(dat.res3_1$RMSE[dat.res3_1$method=="i.KRB1"])
sd(dat.res3_1$RMSE[dat.res3_1$method=="i.KRB1"])
mean(dat.res3_1$RMSE[dat.res3_1$method=="j.KRB2"])
sd(dat.res3_1$RMSE[dat.res3_1$method=="j.KRB2"])
mean(dat.res3_1$RMSE[dat.res3_1$method=="k.KRB3"])
sd(dat.res3_1$RMSE[dat.res3_1$method=="k.KRB3"])
mean(dat.res3_1$RMSE[dat.res3_1$method=="l.KRB4"])
sd(dat.res3_1$RMSE[dat.res3_1$method=="l.KRB4"])

mean(dat.res3_1$RMSE[dat.res3_1$method=="m.KRR1"])
sd(dat.res3_1$RMSE[dat.res3_1$method=="m.KRR1"])
mean(dat.res3_1$RMSE[dat.res3_1$method=="n.KRR2"])
sd(dat.res3_1$RMSE[dat.res3_1$method=="n.KRR2"])
mean(dat.res3_1$RMSE[dat.res3_1$method=="o.KRR3"])
sd(dat.res3_1$RMSE[dat.res3_1$method=="o.KRR3"])
mean(dat.res3_1$RMSE[dat.res3_1$method=="p.KRR4"])
sd(dat.res3_1$RMSE[dat.res3_1$method=="p.KRR4"])
#-----------------------------------------------------#

mean(dat.res3_2$RMSE[dat.res3_2$method=="a.KR1"])
sd(dat.res3_2$RMSE[dat.res3_2$method=="a.KR1"])
mean(dat.res3_2$RMSE[dat.res3_2$method=="b.KR2"])
sd(dat.res3_2$RMSE[dat.res3_2$method=="b.KR2"])
mean(dat.res3_2$RMSE[dat.res3_2$method=="c.KR3"])
sd(dat.res3_2$RMSE[dat.res3_2$method=="c.KR3"])
mean(dat.res3_2$RMSE[dat.res3_2$method=="d.KR4"])
sd(dat.res3_2$RMSE[dat.res3_2$method=="d.KR4"])

mean(dat.res3_2$RMSE[dat.res3_2$method=="e.KRS1"])
sd(dat.res3_2$RMSE[dat.res3_2$method=="e.KRS1"])
mean(dat.res3_2$RMSE[dat.res3_2$method=="f.KRS2"])
sd(dat.res3_2$RMSE[dat.res3_2$method=="f.KRS2"])
mean(dat.res3_2$RMSE[dat.res3_2$method=="g.KRS3"])
sd(dat.res3_2$RMSE[dat.res3_2$method=="g.KRS3"])
mean(dat.res3_2$RMSE[dat.res3_2$method=="h.KRS4"])
sd(dat.res3_2$RMSE[dat.res3_2$method=="h.KRS4"])

mean(dat.res3_2$RMSE[dat.res3_2$method=="i.KRB1"])
sd(dat.res3_2$RMSE[dat.res3_2$method=="i.KRB1"])
mean(dat.res3_2$RMSE[dat.res3_2$method=="j.KRB2"])
sd(dat.res3_2$RMSE[dat.res3_2$method=="j.KRB2"])
mean(dat.res3_2$RMSE[dat.res3_2$method=="k.KRB3"])
sd(dat.res3_2$RMSE[dat.res3_2$method=="k.KRB3"])
mean(dat.res3_2$RMSE[dat.res3_2$method=="l.KRB4"])
sd(dat.res3_2$RMSE[dat.res3_2$method=="l.KRB4"])

mean(dat.res3_2$RMSE[dat.res3_2$method=="m.KRR1"])
sd(dat.res3_2$RMSE[dat.res3_2$method=="m.KRR1"])
mean(dat.res3_2$RMSE[dat.res3_2$method=="n.KRR2"])
sd(dat.res3_2$RMSE[dat.res3_2$method=="n.KRR2"])
mean(dat.res3_2$RMSE[dat.res3_2$method=="o.KRR3"])
sd(dat.res3_2$RMSE[dat.res3_2$method=="o.KRR3"])
mean(dat.res3_2$RMSE[dat.res3_2$method=="p.KRR4"])
sd(dat.res3_2$RMSE[dat.res3_2$method=="p.KRR4"])
#-----------------------------------------------------#

mean(dat.res3_3$RMSE[dat.res3_3$method=="a.KR1"])
sd(dat.res3_3$RMSE[dat.res3_3$method=="a.KR1"])
mean(dat.res3_3$RMSE[dat.res3_3$method=="b.KR2"])
sd(dat.res3_3$RMSE[dat.res3_3$method=="b.KR2"])
mean(dat.res3_3$RMSE[dat.res3_3$method=="c.KR3"])
sd(dat.res3_3$RMSE[dat.res3_3$method=="c.KR3"])
mean(dat.res3_3$RMSE[dat.res3_3$method=="d.KR4"])
sd(dat.res3_3$RMSE[dat.res3_3$method=="d.KR4"])

mean(dat.res3_3$RMSE[dat.res3_3$method=="e.KRS1"])
sd(dat.res3_3$RMSE[dat.res3_3$method=="e.KRS1"])
mean(dat.res3_3$RMSE[dat.res3_3$method=="f.KRS2"])
sd(dat.res3_3$RMSE[dat.res3_3$method=="f.KRS2"])
mean(dat.res3_3$RMSE[dat.res3_3$method=="g.KRS3"])
sd(dat.res3_3$RMSE[dat.res3_3$method=="g.KRS3"])
mean(dat.res3_3$RMSE[dat.res3_3$method=="h.KRS4"])
sd(dat.res3_3$RMSE[dat.res3_3$method=="h.KRS4"])

mean(dat.res3_3$RMSE[dat.res3_3$method=="i.KRB1"])
sd(dat.res3_3$RMSE[dat.res3_3$method=="i.KRB1"])
mean(dat.res3_3$RMSE[dat.res3_3$method=="j.KRB2"])
sd(dat.res3_3$RMSE[dat.res3_3$method=="j.KRB2"])
mean(dat.res3_3$RMSE[dat.res3_3$method=="k.KRB3"])
sd(dat.res3_3$RMSE[dat.res3_3$method=="k.KRB3"])
mean(dat.res3_3$RMSE[dat.res3_3$method=="l.KRB4"])
sd(dat.res3_3$RMSE[dat.res3_3$method=="l.KRB4"])

mean(dat.res3_3$RMSE[dat.res3_3$method=="m.KRR1"])
sd(dat.res3_3$RMSE[dat.res3_3$method=="m.KRR1"])
mean(dat.res3_3$RMSE[dat.res3_3$method=="n.KRR2"])
sd(dat.res3_3$RMSE[dat.res3_3$method=="n.KRR2"])
mean(dat.res3_3$RMSE[dat.res3_3$method=="o.KRR3"])
sd(dat.res3_3$RMSE[dat.res3_3$method=="o.KRR3"])
mean(dat.res3_3$RMSE[dat.res3_3$method=="p.KRR4"])
sd(dat.res3_3$RMSE[dat.res3_3$method=="p.KRR4"])
#-----------------------------------------------------#
...
## p=3, censoring 0%
dat.res1_1 <- fit.ftn(50, 1000, 10) # n=50
dat.res1_2 <- fit.ftn(100, 1000, 10) # n=100
dat.res1_3 <- fit.ftn(200, 1000, 10) # n=200
dat.res1 <- rbind(dat.res1_1, dat.res1_2, dat.res1_3)

## p=3, censoring 10%
dat.res2_1 <- fit.ftn(50, 1000, 3) # n=50
dat.res2_2 <- fit.ftn(100, 1000, 3) # n=100
dat.res2_3 <- fit.ftn(200, 1000, 3) # n=200
dat.res2 <- rbind(dat.res2_1, dat.res2_2, dat.res2_3)

## p=3, censoring 30%
dat.res3_1 <- fit.ftn(50, 1000, 1.76) # n=50
dat.res3_2 <- fit.ftn(100, 1000, 1.76) # n=100
dat.res3_3 <- fit.ftn(200, 1000, 1.76) # n=200
dat.res3 <- rbind(dat.res3_1, dat.res3_2, dat.res3_3)

## p=3, censoring 50%
dat.res4_1 <- fit.ftn(50, 1000, 0.94) # n=50
dat.res4_2 <- fit.ftn(100, 1000, 0.94) # n=100
dat.res4_3 <- fit.ftn(200, 1000, 0.94) # n=200
...
# censoring --> ( 0% : 10 / 10% : 3.65 / 30% : 2.5 / 50% : 1.61 )
dat.gen <- function(n, a, seed=NULL){
  if(!is.null(seed)) set.seed(seed)
  x1.i <- runif(n,-10,10)
  x2.i <- runif(n,-10,10)
...
## p=5, censoring 0%
dat.res5_1 <- fit.ftn(50, 1000, 10) # n=50
dat.res5_2 <- fit.ftn(100, 1000, 10) # n=100
dat.res5_3 <- fit.ftn(200, 1000, 10) # n=200
dat.res5 <- rbind(dat.res5_1, dat.res5_2, dat.res5_3)

## p=5, censoring 10%
dat.res6_1 <- fit.ftn(50, 1000, 3.65) # n=50
dat.res6_2 <- fit.ftn(100, 1000, 3.65) # n=100
dat.res6_3 <- fit.ftn(200, 1000, 3.65) # n=200
dat.res6 <- rbind(dat.res6_1, dat.res6_2, dat.res6_3)

## p=5, censoring 30%
dat.res7_1 <- fit.ftn(50, 1000, 2.5) # n=50
dat.res7_2 <- fit.ftn(100, 1000, 2.5) # n=100
dat.res7_3 <- fit.ftn(200, 1000, 2.5) # n=200
dat.res7 <- rbind(dat.res7_1, dat.res7_2, dat.res7_3)

## p=5, censoring 50%
dat.res8_1 <- fit.ftn(50, 1000, 1.61) # n=50
dat.res8_2 <- fit.ftn(100, 1000, 1.61) # n=100
dat.res8_3 <- fit.ftn(200, 1000, 1.61) # n=200
...
## p=10, censoring 0%
dat.res9_1 <- fit.ftn(50, 1000, 10) # n=50
dat.res9_2 <- fit.ftn(100, 1000, 10) # n=100
dat.res9_3 <- fit.ftn(200, 1000, 10) # n=200
dat.res9 <- rbind(dat.res9_1, dat.res9_2, dat.res9_3)

## p=10, censoring 10%
dat.res10_1 <- fit.ftn(50, 1000, 5.5) # n=50
dat.res10_2 <- fit.ftn(100, 1000, 5.5) # n=100
dat.res10_3 <- fit.ftn(200, 1000, 5.5) # n=200
dat.res10 <- rbind(dat.res10_1, dat.res10_2, dat.res10_3)

## p=10, censoring 30%
dat.res11_1 <- fit.ftn(50, 1000, 4.2) # n=50
dat.res11_2 <- fit.ftn(100, 1000, 4.2) # n=100
dat.res11_3 <- fit.ftn(200, 1000, 4.2) # n=200
dat.res11 <- rbind(dat.res11_1, dat.res11_2, dat.res11_3)

## p=10, censoring 50%
dat.res12_1 <- fit.ftn(50, 1000, 3.31) # n=50
dat.res12_2 <- fit.ftn(100, 1000, 3.31) # n=100
dat.res12_3 <- fit.ftn(200, 1000, 3.31) # n=200
...
# censoring --> ( 0% : 20 / 10% : 9.1 / 30% : 7.63 / 50% : 1.61 )
dat.gen <- function(n, a, seed=NULL){
  if(!is.null(seed)) set.seed(seed)
  x1.i <- runif(n,-10,10)
  x2.i <- runif(n,-10,10)
...
## p=20, censoring 0%
dat.res13_1 <- fit.ftn(50, 1000, 20) # n=50
dat.res13_2 <- fit.ftn(100, 1000, 20) # n=100
dat.res13_3 <- fit.ftn(200, 1000, 20) # n=200
dat.res13 <- rbind(dat.res13_1, dat.res13_2, dat.res13_3)

## p=20, censoring 10%
dat.res14_1 <- fit.ftn(50, 1000, 9.1) # n=50
dat.res14_2 <- fit.ftn(100, 1000, 9.1) # n=100
dat.res14_3 <- fit.ftn(200, 1000, 9.1) # n=200
dat.res14 <- rbind(dat.res14_1, dat.res14_2, dat.res14_3)

## p=20, censoring 30%
dat.res15_1 <- fit.ftn(50, 1000, 7.63) # n=50
dat.res15_2 <- fit.ftn(100, 1000, 7.63) # n=100
dat.res15_3 <- fit.ftn(200, 1000, 7.63) # n=200
dat.res15 <- rbind(dat.res15_1, dat.res15_2, dat.res15_3)

## p=20, censoring 50%
dat.res16_1 <- fit.ftn(50, 1000, 6.64) # n=50
dat.res16_2 <- fit.ftn(100, 1000, 6.64) # n=100
dat.res16_3 <- fit.ftn(200, 1000, 6.64) # n=200
