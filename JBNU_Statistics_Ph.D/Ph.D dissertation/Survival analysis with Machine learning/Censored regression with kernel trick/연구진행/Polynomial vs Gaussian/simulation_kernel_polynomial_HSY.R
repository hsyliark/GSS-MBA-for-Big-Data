...
ggplot(dat.res11_1, aes(x = method, y = RMSE, fill = method)) + geom_boxplot() 
ggplot(dat.res11_2, aes(x = method, y = RMSE, fill = method)) + geom_boxplot()
ggplot(dat.res11_3, aes(x = method, y = RMSE, fill = method)) + geom_boxplot()
# Boxplot for row binded dataset
dat.res11[dat.res11$number==50,]$number <- "1(50)"
dat.res11[dat.res11$number==100,]$number <- "2(100)"
dat.res11[dat.res11$number==200,]$number <- "3(200)"
ggplot(dat.res11, aes(x = number, y = RMSE, fill = number)) + geom_boxplot() +
  facet_wrap(~ method, ncol=16) + theme(axis.text.x=element_text(angle=45, hjust=1))
write.csv(dat.res11, "C:/Users/Hi/Desktop/Polynomial vs Gaussian/p7cen30.csv")
...
# censoring --> ( 0% : 10 / 10% : 3.55  / 30% : 2.43 / 50% : 1.65 )
dat.gen <- function(n, a, seed=NULL){
  ...
  y.i <- rnorm(n, mean=1+(x1.i/10)^2+(x2.i/10)^2, sd=1)
...
## p=3, censoring 10%
dat.res2_1 <- fit.ftn(50, 1000, 3.55) # n=50
dat.res2_2 <- fit.ftn(100, 1000, 3.55) # n=100
dat.res2_3 <- fit.ftn(200, 1000, 3.55) # n=200
dat.res2 <- rbind(dat.res2_1, dat.res2_2, dat.res2_3)

## p=3, censoring 30%
dat.res3_1 <- fit.ftn(50, 1000, 2.43) # n=50
dat.res3_2 <- fit.ftn(100, 1000, 2.43) # n=100
dat.res3_3 <- fit.ftn(200, 1000, 2.43) # n=200
dat.res3 <- rbind(dat.res3_1, dat.res3_2, dat.res3_3)

## p=3, censoring 50%
dat.res4_1 <- fit.ftn(50, 1000, 1.65) # n=50
dat.res4_2 <- fit.ftn(100, 1000, 1.65) # n=100
dat.res4_3 <- fit.ftn(200, 1000, 1.65) # n=200
...
# censoring --> ( 0% : 15 / 10% : 3.9 / 30% : 2.8 / 50% : 1.95 )
dat.gen <- function(n, a, seed=NULL){
  if(!is.null(seed)) set.seed(seed)
  x1.i <- runif(n,-10,10)
  x2.i <- runif(n,-10,10)
  ...
  x5.i <- runif(n,-10,10)
  # e.i <- rnorm(n, mean=0, sd=1)
  y.i <- rnorm(n, mean=1+(x1.i/10)^2+(x2.i/10)^2+(x3.i/10)^2,
               sd=1)
  # pred.value <- sin(2*pi*(x1.i*x2.i*x3.i*x4.i*x5.i))+cos(2*pi*(x6.i*x7.i*x8.i*x9.i*x10.i))
  cen <- rnorm(n, mean=a, sd=1) # censoring values
  pre.T <- pmin(y.i, cen)
...
## p=5, censoring 10%
dat.res6_1 <- fit.ftn(50, 1000, 3.9) # n=50
dat.res6_2 <- fit.ftn(100, 1000, 3.9) # n=100
dat.res6_3 <- fit.ftn(200, 1000, 3.9) # n=200
dat.res6 <- rbind(dat.res6_1, dat.res6_2, dat.res6_3)

## p=5, censoring 30%
dat.res7_1 <- fit.ftn(50, 1000, 2.8) # n=50
dat.res7_2 <- fit.ftn(100, 1000, 2.8) # n=100
dat.res7_3 <- fit.ftn(200, 1000, 2.8) # n=200
dat.res7 <- rbind(dat.res7_1, dat.res7_2, dat.res7_3)

## p=5, censoring 50%
dat.res8_1 <- fit.ftn(50, 1000, 1.95) # n=50
dat.res8_2 <- fit.ftn(100, 1000, 1.95) # n=100
dat.res8_3 <- fit.ftn(200, 1000, 1.95) # n=200
...
# censoring --> ( 0% : 20 / 10% : 4.25 / 30% : 3.13 / 50% : 2.3 )
dat.gen <- function(n, a, seed=NULL){
  if(!is.null(seed)) set.seed(seed)
  x1.i <- runif(n,-10,10)
  x2.i <- runif(n,-10,10)
  ...
  x7.i <- runif(n,-10,10)
  # e.i <- rnorm(n, mean=0, sd=1)
  y.i <- rnorm(n, mean=1+(x1.i/10)^2+(x2.i/10)^2+(x3.i/10)^2+(x4.i/10)^2,
               sd=1)
  # pred.value <- sin(2*pi*(x1.i*x2.i*x3.i*x4.i*x5.i))+cos(2*pi*(x6.i*x7.i*x8.i*x9.i*x10.i))
  cen <- rnorm(n, mean=a, sd=1) # censoring values
  pre.T <- pmin(y.i, cen)
...
## p=7, censoring 10%
dat.res10_1 <- fit.ftn(50, 1000, 4.25) # n=50
dat.res10_2 <- fit.ftn(100, 1000, 4.25) # n=100
dat.res10_3 <- fit.ftn(200, 1000, 4.25) # n=200
dat.res10 <- rbind(dat.res10_1, dat.res10_2, dat.res10_3)

## p=7, censoring 30%
dat.res11_1 <- fit.ftn(50, 1000, 3.13) # n=50
dat.res11_2 <- fit.ftn(100, 1000, 3.13) # n=100
dat.res11_3 <- fit.ftn(200, 1000, 3.13) # n=200
dat.res11 <- rbind(dat.res11_1, dat.res11_2, dat.res11_3)

## p=7, censoring 50%
dat.res12_1 <- fit.ftn(50, 1000, 2.3) # n=50
dat.res12_2 <- fit.ftn(100, 1000, 2.3) # n=100
dat.res12_3 <- fit.ftn(200, 1000, 2.3) # n=200
...
# censoring --> ( 0% : 25 / 10% : 4.65 / 30% : 3.45 / 50% : 2.6 )
dat.gen <- function(n, a, seed=NULL){
  if(!is.null(seed)) set.seed(seed)
  x1.i <- runif(n,-10,10)
  x2.i <- runif(n,-10,10)
...
## p=9, censoring 10%
dat.res14_1 <- fit.ftn(50, 1000, 4.65) # n=50
dat.res14_2 <- fit.ftn(100, 1000, 4.65) # n=100
dat.res14_3 <- fit.ftn(200, 1000, 4.65) # n=200
dat.res14 <- rbind(dat.res14_1, dat.res14_2, dat.res14_3)

## p=9, censoring 30%
dat.res15_1 <- fit.ftn(50, 1000, 3.45) # n=50
dat.res15_2 <- fit.ftn(100, 1000, 3.45) # n=100
dat.res15_3 <- fit.ftn(200, 1000, 3.45) # n=200
dat.res15 <- rbind(dat.res15_1, dat.res15_2, dat.res15_3)

## p=9, censoring 50%
dat.res16_1 <- fit.ftn(50, 1000, 2.6) # n=50
dat.res16_2 <- fit.ftn(100, 1000, 2.6) # n=100
dat.res16_3 <- fit.ftn(200, 1000, 2.6) # n=200
