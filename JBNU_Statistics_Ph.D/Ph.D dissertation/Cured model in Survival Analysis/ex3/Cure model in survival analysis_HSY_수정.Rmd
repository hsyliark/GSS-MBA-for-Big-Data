...
predm <- predictsmcure(pd,newX=cbind(c(1,0),c(0,0),c(0.579,0.579)),newZ=cbind(c(1,0),c(0,0),c(0.579,0.579)),model="ph")
...
# Survival curves
t <- 1:nrow(Dat)
plot(t,1-resMY[["estimCDF"]],type="l",main="Survival Function of Promotion Time Cure Model")
```
