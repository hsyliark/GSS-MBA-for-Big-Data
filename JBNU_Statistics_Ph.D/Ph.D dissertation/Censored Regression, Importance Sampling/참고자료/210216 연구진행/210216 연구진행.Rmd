...
### Case2) g(x) : Weibull(2,3) , h(x) : Weibull(3,4)
...
- 이에 대해 g(x) : Weibull(2,3) 에서 난수를 추출한 경우와 h(x) : Weibull(3,4) 를 이용한 importance sampling을 적용했을 때 분산이 어떻게 차이가 나는지 모의실험을 통해 확인하는 것이 목적임.
