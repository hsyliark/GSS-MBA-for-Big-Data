...
- When $X \sim B(100,0.25)$, calculate $P(X \geq 75)$
- Let $m=100,x=75,p=0.25$ and $q=0.75$. Then, $p << q$.
- $P(X \geq x) = \frac  {1}  {n} \sum _{i=1} ^{n} I(Y _{i} \geq x) ( \frac {p} {q}  ) ^{Y _{i}} ( \frac {1-p} {1-q} ) ^{m-Y _{i}}$
- Therefore, $P(X \geq 75) = \frac  {1} {n} \sum _{i=1} ^{n} I(Y _{i} \geq 75) * 3 ^{100-2Y _{i}}$
...
- Suppose that $X \sim N(0,1 ^{2} ),Y \sim N(2.575,1 ^{2} )$.
- Then we want to calculate $P(X>=2.575)$.

#### 분포함수 h(x)가 N(0,1)인 정규분포에 대하여 sampling 후 점검
- $P(X \geq 2.575)= \int _{2.575} ^{\infty } {f _{X} (x)dx=p _{2.575}}$ 
- ${\hat{p _{2.575}}} = \frac {1} {n} \sum _{i=1} ^{n} I(X _{i} \geq 2.575)$
...
- $P(X \geq 2.575)= \int _{2.575} ^{\infty } {f _{X} (x)dx= \int _{2.575} ^{\infty } [{{f _{X} (y)} / {f _{Y} (y)}] f _{Y} (y)dy=p _{2.575}^{IS}}}$ 
- ${\hat{p _{2.575}^{IS}}} = \frac {1} {n} \sum _{i=1} ^{n} I(Y _{i} \geq 2.575) \frac {f _{X} (Y _{i} )} {f _{Y} (Y _{i} )} = \frac {1} {n} \sum _{i=1} ^{n} I(Y _{i} \geq 2.575)*exp[- \frac {1} {2} (Y _{i}^{2} +(Y _{i} -2.575) ^{2} )]$
...
#### h(x) -> Exp(1)
- $E(e ^{-X+cos(X)} )= \int _{0} ^{\infty } {f(x)g(x)dx} = \int _{0} ^{\infty } {e ^{-x+cos(x)} e ^{-x} dx} =a$
...
#### h(x) -> Exp(2)
- $E(e ^{-X+cos(X)} )= \int _{0} ^{\infty } {f(x)g(x)dx} = \int _{0} ^{\infty } {\frac {f(y)g(y)}  {h(y)} h(y)dy} = \int _{0} ^{\infty } {\frac {e ^{-y+cos(y)} e ^{-y}} {2e ^{-2y}} 2e ^{-2y} dy} =b$
