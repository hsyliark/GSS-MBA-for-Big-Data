...
ISV <- c()
for (i in 1:1000) {
  gr <- rgamma(1000,shape=2,scale=40) # 특정한 분포에서 난수 추출
  f3 <- fitdist(gr,"gamma") # 특정한 분포는 잊어버리고 추출된 난수에 대하여 분포 g(x)를 추정 
  GM[i] <- mean(gr)
  GV[i] <- var(gr)
  # 추정된 분포 g(x)에 대해 모수를 조절하여 적절한 대체분포 h(x)를 설정
...
```{r}
(MSE.GM <- mean((res3_1$mean[res3_1$method=="Sampling"]-80)^2)) ; (MSE.ISM <- mean((res3_1$mean[res3_1$method=="Importance Sampling"]-80)^2))
MSE.GM > MSE.ISM
(Var.GM <- mean((res3_1$mean[res3_1$method=="Sampling"]-mean(res3_1$mean[res3_1$method=="Sampling"]))^2)) ; (Var.ISM <- mean((res3_1$mean[res3_1$method=="Importance Sampling"]-mean(res3_1$mean[res3_1$method=="Importance Sampling"]))^2))
Var.GM > Var.ISM
(Bias2.GM <- (mean(res3_1$mean[res3_1$method=="Sampling"])-80)^2) ; (Bias2.ISM <- (mean(res3_1$mean[res3_1$method=="Importance Sampling"])-80)^2)
Bias2.GM > Bias2.ISM
```
...
```{r}
(MSE.GM <- mean((res3_2$mean[res3_2$method=="Sampling"]-80)^2)) ; (MSE.ISM <- mean((res3_2$mean[res3_2$method=="Importance Sampling"]-80)^2))
MSE.GM > MSE.ISM
(Var.GM <- mean((res3_2$mean[res3_2$method=="Sampling"]-mean(res3_2$mean[res3_2$method=="Sampling"]))^2)) ; (Var.ISM <- mean((res3_2$mean[res3_2$method=="Importance Sampling"]-mean(res3_2$mean[res3_2$method=="Importance Sampling"]))^2))
Var.GM > Var.ISM
(Bias2.GM <- (mean(res3_2$mean[res3_2$method=="Sampling"])-80)^2) ; (Bias2.ISM <- (mean(res3_2$mean[res3_2$method=="Importance Sampling"])-80)^2)
Bias2.GM > Bias2.ISM
```
...
```{r}
(MSE.GM <- mean((res3_3$mean[res3_3$method=="Sampling"]-80)^2)) ; (MSE.ISM <- mean((res3_3$mean[res3_3$method=="Importance Sampling"]-80)^2))
MSE.GM > MSE.ISM
(Var.GM <- mean((res3_3$mean[res3_3$method=="Sampling"]-mean(res3_3$mean[res3_3$method=="Sampling"]))^2)) ; (Var.ISM <- mean((res3_3$mean[res3_3$method=="Importance Sampling"]-mean(res3_3$mean[res3_3$method=="Importance Sampling"]))^2))
Var.GM > Var.ISM
(Bias2.GM <- (mean(res3_3$mean[res3_3$method=="Sampling"])-80)^2) ; (Bias2.ISM <- (mean(res3_3$mean[res3_3$method=="Importance Sampling"])-80)^2)
Bias2.GM > Bias2.ISM
```
...
```{r}
(MSE.GM <- mean((res3_4$mean[res3_4$method=="Sampling"]-80)^2)) ; (MSE.ISM <- mean((res3_4$mean[res3_4$method=="Importance Sampling"]-80)^2))
MSE.GM > MSE.ISM
(Var.GM <- mean((res3_4$mean[res3_4$method=="Sampling"]-mean(res3_4$mean[res3_4$method=="Sampling"]))^2)) ; (Var.ISM <- mean((res3_4$mean[res3_4$method=="Importance Sampling"]-mean(res3_4$mean[res3_4$method=="Importance Sampling"]))^2))
Var.GM > Var.ISM
(Bias2.GM <- (mean(res3_4$mean[res3_4$method=="Sampling"])-80)^2) ; (Bias2.ISM <- (mean(res3_4$mean[res3_4$method=="Importance Sampling"])-80)^2)
Bias2.GM > Bias2.ISM
```
...
```{r}
(MSE.GM <- mean((res3_5$mean[res3_5$method=="Sampling"]-80)^2)) ; (MSE.ISM <- mean((res3_5$mean[res3_5$method=="Importance Sampling"]-80)^2))
MSE.GM > MSE.ISM
(Var.GM <- mean((res3_5$mean[res3_5$method=="Sampling"]-mean(res3_5$mean[res3_5$method=="Sampling"]))^2)) ; (Var.ISM <- mean((res3_5$mean[res3_5$method=="Importance Sampling"]-mean(res3_5$mean[res3_5$method=="Importance Sampling"]))^2))
Var.GM > Var.ISM
(Bias2.GM <- (mean(res3_5$mean[res3_5$method=="Sampling"])-80)^2) ; (Bias2.ISM <- (mean(res3_5$mean[res3_5$method=="Importance Sampling"])-80)^2)
Bias2.GM > Bias2.ISM
```
